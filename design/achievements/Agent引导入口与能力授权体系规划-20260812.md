...
> 归档说明：2026-08-22 移入 `design/achievements/`。WBS-0～9 已完成；WBS-10 已由现行 MCP 设计接管。本文保留 Agent Bootstrap、Skills 分发和早期授权体系的实施历史，不覆盖现行权限、MCP 与 AI-native 三份规划基石。  
...
- 修改：`design/achievements/Agent引导入口与能力授权体系规划-20260812.md`
