...
| --- | --- | --- | --- | --- | --- |
| WBS-MCP-P0 | 目标客户端兼容性预检 | 权限阶段 0 的安全基线 | 0.5–1 人日 | 双客户端能力矩阵与 HTTP/stdio go/no-go | 待开发 |
| WBS-MCP-0 | SDK 无关业务与安全契约 | WBS-MCP-P0 go | 0.5–1 人日 | 工具/字段/错误/权限契约、威胁模型 | 待开发 |
| WBS-MCP-1 | 协议、SDK 与传输契约冻结 | WBS-MCP-P0、0 | 0.5–1 人日 | 可运行的最小 HTTP Server 与冻结兼容结论 | 待开发 |
| WBS-MCP-2 | 共享 Catalog Read Model 复用与隐私契约 | 权限阶段 1、WBS-MCP-0 | 0.5–1 人日 | MCP 复用适配与隐私契约 | 待开发 |
...
| WBS-MCP-7 | 共享限流/审计适配与隐私加固 | 共享安全基础、WBS-MCP-4、5 | 0.5–1 人日 | 协议维度适配、隐私快照与异常检测 | 待开发 |
| WBS-MCP-8 | 发现、文档与客户端接入 | WBS-MCP-5、7 | 1–1.5 人日 | Manifest、部署与客户端配置文档 | 待开发 |
| WBS-MCP-9 | 端到端评估与发布门禁 | 核心档：WBS-MCP-P0、0–5、7、8；扩展档另加 WBS-MCP-6 | 1–2 人日 | Inspector、双客户端、评估集、回滚验证 | 待开发 |
